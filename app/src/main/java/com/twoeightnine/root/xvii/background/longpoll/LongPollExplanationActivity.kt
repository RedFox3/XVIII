...
import com.twoeightnine.root.xvii.databinding.ActivityExplanationBinding
...
class LongPollExplanationActivity : BaseActivity() {
    ...
    private val binding by lazy { ActivityExplanationBinding.inflate(layoutInflater) }
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    startActivity(Intent(Settings.ACTION_CHANNEL_NOTIFICATION_SETTINGS).apply {
                        ...
                        putExtra(
                            ...
                            NotificationChannels.backgroundService.id
                        )
                    })
                }
            }
            btnSupport.setOnClickListener {
                ChatActivity.launch(this@LongPollExplanationActivity, -App.GROUP, getString(R.string.app_name))
            }
